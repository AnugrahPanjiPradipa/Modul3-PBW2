        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('collection.registrasi') }}" class="btn btn-icon btn-dark">Tambah</a><br><br>
                            ...
                            @foreach($koleksi as $key => $koleksii)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">
                                        <a href="{{ route('collection.infoKoleksi', $koleksii->id) }}" class="btn btn-icon btn-sm btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
